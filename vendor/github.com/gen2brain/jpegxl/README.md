...
* `wasm2go` - transpile WASM to Go instead of using wazero; decodes with [jxl-rs](https://github.com/libjxl/jxl-rs) and encodes losslessly with [zune-jpegxl](https://github.com/etemesi254/zune-image)
